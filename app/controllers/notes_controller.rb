class NotesController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @note.save
        @feed = @note.feeds.create(organization_id: @organization_id, company_id: @company.id, content: @note.description)
        # @feeds = @company.feeds
  ...
  def update
    ...
    respond_to do |format|
      if @note.update(note_params) & @feed.update(content: params[:Note][:content])
